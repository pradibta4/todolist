                    ...
                    <form>
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base/7 font-semibold text-gray-900">Create a New Team</h2>
                                <p class="mt-1 text-sm/6 text-gray-600">Set up your team by adding a name and selecting team members.</p>
            ...
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                <table class="min-w-full leading-normal">
                    <thead class="bg-gray-100 uppercase tracking-wider dark:bg-[#443C68] dark:text-white">
                        <tr>
                            <th scope="col" class="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold dark:border-gray-600">Team Name</th>
                            ...
                            <th scope="col" class="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold dark:border-gray-600">Members</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[#6B5B95] transition-colors">
                                <td class="px-5 py-5 text-sm">
                                    <div class="flex items-center">
                                        <div class="ml-3">
                                            <p class="whitespace-no-wrap" x-text="team.name"></p>
                                        </div>
                                    </div>
                                </td>
